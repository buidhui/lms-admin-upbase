...
| ---------------- | --------------------------------------------- | --------------------- | ----------------------------------------------------------------- | --------- |
| 23/06/2026       | [it-ba@sapp.edu.vn](mailto:it-ba@sapp.edu.vn) | A                     | Viết lại theo template chuẩn Gitbook từ UG cũ (Confluence v1.7.0) | v2.0.0    |
...
<summary>Tạo mới bài kiểm tra</summary>
...
* Mỗi sự kiện (Event) của một chương trình học chỉ được tạo **1 bài kiểm tra duy nhất** — kiểm tra danh sách trước khi tạo mới.
{% endhint %}
...
<summary>Chỉnh sửa bài kiểm tra</summary>
...
<summary>Xem danh sách học viên theo bài kiểm tra</summary>
...
<summary>Xem tất cả học viên (All Participants)</summary>
...
{% step %}
## (Tuỳ chọn) Tìm kiếm theo: Tên/Email/Số điện thoại, Program, Event, Sort by

Click **Search** · **Reset** để xóa.
{% endstep %}
{% endstepper %}
...
<summary>Xem chi tiết kết quả/bài làm học viên</summary>
...
📩 Chưa tự xử lý được? Liên hệ **Hotline 1900 2225** hoặc tạo ticket tại [https://sapp.edu.vn/dich-vu-cham-soc-hoc-vien-sapp-academy/](https://sapp.edu.vn/dich-vu-cham-soc-hoc-vien-sapp-academy/).
