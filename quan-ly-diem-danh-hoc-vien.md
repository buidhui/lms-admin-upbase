...
| 3 | Dahahi   | Hệ thống điểm danh bằng thiết bị phần cứng (offline check-in) |
| 4 | Zoom     | Nền tảng học trực tuyến; dữ liệu vào/ra được đồng bộ về LMS   |
| 5 | Admin CX | Người dùng quản trị vận hành lớp học                          |
...
{% step %}
### Chọn buổi học cần điểm danh bù
...
<summary><strong>Q: Dữ liệu điểm danh từ Dahahi và Zoom có đồng bộ về LMS theo thời gian thực không?</strong></summary>
...
<summary><strong>Q: Chức năng điểm danh bù và chỉnh sửa điểm danh có áp dụng cho lớp Dahahi không?</strong></summary>
...
<summary><strong>Q: Khi học viên dùng nhiều thiết bị Zoom cùng lúc, hệ thống tính thế nào?</strong></summary>
