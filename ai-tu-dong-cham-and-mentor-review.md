...
### AI tự động chấm bài sau khi học viên nộp
...
### Trạng thái AI chấm bài & logic quy đổi điểm
...
### Xem kết quả AI theo từng câu hỏi/requirement
...
![](<.gitbook/assets/image (786)>)

![](<.gitbook/assets/image (788)>)
{% endstep %}

{% step %}
## Bấm "Delete" để xóa nhận xét/điểm

![](<.gitbook/assets/image (790)>)
{% endstep %}
...
{% hint style="info" %}
**Lưu ý tính điểm:** Tổng điểm = Điểm AI + Điểm chấm tay bổ sung. Tổng không được vượt quá điểm tối đa của Question/Requirement. Thông báo lỗi khi vượt: _"Grading score exceeds Question's/Requirement's maximum score"_.
{% endhint %}
{% endstep %}
{% endstepper %}
...
![](<.gitbook/assets/image (791)>)

![](<.gitbook/assets/image (793)>)
