...
| -------------- | --------------- | ----- | ---------------------------------------------------------- | ------- | -------------- |
| Jun 24, 2026   | Nguyễn Duy Hiếu | A     | Khởi tạo tài liệu hướng dẫn chức năng Chấm công Giảng viên | 1.0.0   | Jun 24, 2026   |
...
<table><thead><tr><th width="80">STT</th><th width="231">Chức năng</th><th>Mô tả ngắn</th></tr></thead><tbody><tr><td>1</td><td>Xem chấm công giảng viên theo Lớp học</td><td>Xem cột Attendance (công thực tế / công chuẩn) của từng giảng viên trong một lớp tại Class Detail → tab Teacher.</td></tr><tr><td>2</td><td>Xem chi tiết chấm công theo từng buổi (trong lớp)</td><td>Mở màn [Tên GV]'s Attendance từ lớp để xem check-in/out, công thực tế và lịch sử chấm công theo từng buổi.</td></tr><tr><td>3</td><td>Xem bảng chấm công theo Giảng viên</td><td>Xem tổng hợp chấm công theo tháng tại Operations → Customer Experience → Teacher → tab Attendance.</td></tr><tr><td>4</td><td>Xem chi tiết chấm công theo từng buổi (theo giảng viên)</td><td>Mở màn [Tên GV]'s Attendance từ tab Teacher để xem chi tiết theo từng buổi, lọc theo lớp và hình thức học.</td></tr><tr><td>5</td><td>Business Rules — Chấm công Giảng viên</td><td>Quy tắc xác định ca dạy, gộp ca, mapping dữ liệu Zoom/Dahahi và cách tính công của giảng viên.</td></tr></tbody></table>
