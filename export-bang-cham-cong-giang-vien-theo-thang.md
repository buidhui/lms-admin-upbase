...
### Export bảng chấm công giảng viên
...
![](<.gitbook/assets/image (771)>)
{% endstep %}

{% step %}
## Ấn nút "Export"

![](<.gitbook/assets/image (772)>)
{% endstep %}
{% endstepper %}

### Bộ lọc trên màn Attendance
...
### Thông tin hiển thị trên màn Attendance
...
### Nội dung & định dạng file Export
