...
### Review bài trước khi gửi kết quả

{% stepper %}
{% step %}
## Gửi bài review

Khi chấm bài, người dùng chọn **Submit to review** để gửi bài cho Mentor chính review. Mentor chính nhận thông báo qua email.
{% endstep %}

{% step %}
## Mentor chính xử lý

Trên màn chấm, Mentor chính có 2 lựa chọn:
...
### Học viên yêu cầu chấm lại (Request Regrading)

{% stepper %}
{% step %}
## Gửi yêu cầu

Tại kết quả bài test, học viên chọn **Request Regrading** để yêu cầu chấm lại.
{% endstep %}

{% step %}
## Nhập lý do

Học viên nhập lý do chấm lại.
{% endstep %}

{% step %}
## Lưu

Học viên chọn **Save** để lưu yêu cầu. Sau khi gửi thành công, hệ thống gửi thông báo cho Mentor chính.
{% endstep %}
{% endstepper %}
