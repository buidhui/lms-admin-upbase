...
### Cài đặt Grading Files cho câu hỏi tự luận
...
Nhập nội dung câu hỏi, Solution...
{% endstep %}
...
### Chi tiết mục Grading Files for AI
...
### Logic khi chỉnh sửa/xóa Grading Files
...
### Cài đặt Context File cho khóa học
...
![](<.gitbook/assets/image (792)>)
{% endstep %}

{% step %}
## Điền Description for AI cho từng file

Tối đa 500 ký tự.

![](<.gitbook/assets/image (794)>)
{% endstep %}
...
### Cài đặt bài Test/Quiz cho AI chấm tự động
...
![](<.gitbook/assets/image (795)>)
{% endstep %}

{% step %}
## Chọn câu hỏi cần add vào bài Test/Quiz

![](<.gitbook/assets/image (796)>)
{% endstep %}
...
![](<.gitbook/assets/image (797)>)
{% endstep %}

{% step %}
## Sắp xếp thứ tự các câu trong bài Test/Quiz

![](<.gitbook/assets/image (798)>)
{% endstep %}
