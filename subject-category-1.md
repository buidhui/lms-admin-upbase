...
### 1. Xem danh sách Subject Category
...
{% stepper %}
{% step %}
#### Admin thực hiện click button Add Subject tại màn hình

![](<.gitbook/assets/image (559)>)
{% endstep %}

{% step %}
#### Admin nhập thông tin vào màn hình tạo mới Subject hiển thị phía bên phải như ảnh dưới đây
...
{% hint style="warning" %}
**Lưu ý:** Subject đã gán với khóa học thì không thể xóa.
{% endhint %}
