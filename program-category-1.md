...
### 1. Xem danh sách Program Category
...
{% stepper %}
{% step %}
#### Admin thực hiện click button Add Category tại màn hình

![](<.gitbook/assets/image (556)>)
{% endstep %}

{% step %}
#### Admin nhập thông tin vào màn hình tạo mới Program hiển thị phía bên phải như ảnh dưới đây
...
{% hint style="warning" %}
**Lưu ý:** Program đã tạo thì không thể xóa khỏi danh sách.
{% endhint %}
