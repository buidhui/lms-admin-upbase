...
![](<.gitbook/assets/image (1028)>)

![](<.gitbook/assets/image (1029)>)
...
### 1. Tạo mới bài Test/Quiz

#### 1.1. Cài đặt thông tin chung
...
Admin click button **Add & Create** để thêm câu hỏi, tạo bài test theo thông tin đã càu đặt trước đó, đồng thời chuyển sang bước **Setup Score**.
...
{% stepper %}
{% step %}
## Cài đặt điểm cho bài Test/Quiz
...
| Trường thông tin   | Mô tả                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Total Score        | Tổng điểm tối đa của bài Test/Quiz, cho phép người dùng điền số lớn hơn 0 và có thể khác 100. Khi thay đổi Total Score, hệ thống sẽ tự động tính lại toàn bộ điểm của từng Question (Mark) nếu Score Distribution = Evenly across all questions hoặc Evenly by Question Type                                                                                                                                                                                      |
...
**Cách 1: Kéo thả câu hỏi**

Di chuyển con trỏ chuột đến icon di chuyển và nhấn giữ để thay đổi vị trí câu hỏi.

![](<.gitbook/assets/image (1020)>)

**Cách 2: Chọn Move to top/Move to bottom**

Di chuyển câu hỏi đến vị trí đầu danh sách/cuối danh sách bằng cách chọn **Action > Move to top/Move to bottom**.

![](<.gitbook/assets/image (1021)>)

**Cách 3: Chọn Move to position**

Di chuyển câu hỏi đến một vị trí xác định bằng cách chọn **Action > Move to position > Điền vị trí muốn chuyển câu hỏi đến > Save.**
...
Sau khi hoàn tất sắp xếp, chọn **Finish**. Lúc này người dùng sẽ được điều hướng quay lại màn hình Test/Quiz Detail.
...
### 2. Chỉnh sửa bài Test/Quiz đã tạo

{% stepper %}
{% step %}
## Chỉnh sửa thông tin bài Test/Quiz

Truy cập vào bài Test/quiz cần chỉnh sửa. Tại màn hình chi tiết bài Test/Quiz, người dùng có thể chỉnh sửa các thông tin sau, thao tác tương tự mục _**1. Tạo mới bài Test/Quiz**_:
