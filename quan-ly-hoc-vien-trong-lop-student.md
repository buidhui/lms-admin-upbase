# quan ly hoc vien trong lop student
...
<figure><img src="https://sapp-academy.gitbook.io/files/VvwQafCdeXTNdOLki54R" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/xi3QNRveropAU4Pve1mO" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/BHhqB5BCZxexUfZQCyFL" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/1PPhKezkL22sgqDChPAb" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/eBJ8TdJoqP8spL46PYPI" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/PzrZu2f626N4OUfcAojN" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/0QBGslEk5QG4hGbsWMHd" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/0bX3sO2Snd2PV9FQZxX6" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/oOmCfVG2kHRLj6MlAU1i" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/ZGHs6w5BWWrisoZnGORi" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/Wb5XICltyKE3BVy7AXRz" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/zrpJ7RGoW4aNZG80zEom" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/x8qj3Yf6rLfTBsFwahdI" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="https://sapp-academy.gitbook.io/files/NmSXN3GcDrYcCY4qGARI" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
| Thao tác                  | Quy tắc                                                                                                           |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| **Chọn/Bỏ chọn All**      | Tất cả checkbox cấu phần học được tick hoặc bỏ tick.                                                              |
| **Chọn Section**          | Tất cả Subsection, Unit, Activity, Quiz thuộc Section được chọn.                                                  |
| **Chọn Subsection**       | Section, các Unit, Activity, Case Study liên quan đến Subsection được chọn.                                       |
| **Chọn Unit**             | Section, Subsection và các Activity liên quan đến Unit được chọn.                                                 |
| **Chọn Activity**         | Section, Subsection và Unit chứa Activity đó được chọn.                                                           |
| **Bỏ chọn cấu phần học**  | Cấu phần bị bỏ chọn sẽ không xuất hiện trong chương trình học của học viên và học viên không cần học cấu phần đó. |
| **Xóa cấu phần đã học**   | Không được phép xóa khỏi chương trình học của học viên.                                                           |
| **Xóa cấu phần chưa học** | Được phép xóa khỏi chương trình học của học viên.                                                                 |
