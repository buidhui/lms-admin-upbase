...
**Bước 1:** Truy cập màn hình tạo mới nhóm sản phẩm
...
<table><thead><tr><th width="155">Trường thông tin</th><th>Cách xử lý</th></tr></thead><tbody><tr><td>Category</td><td>Hệ thống tự tổng hợp các chương trình học của từng sản phẩm trong nhóm. Người dùng không cần điền thông tin này</td></tr><tr><td>Price</td><td>Hệ thống tự tính bằng tổng giá trị của các sản phẩm trong nhóm. Người dùng không cần điền thông tin này</td></tr></tbody></table>
...
**Bước 5:** Chọn trạng thái nhóm sản phẩm

Tại trường **Status**, chọn trạng thái của nhóm sản phẩm.

<table><thead><tr><th width="135.33331298828125">Trường thông tin</th><th width="100.33331298828125">Bắt buộc</th><th width="93.66668701171875">Giá trị</th><th>Ý nghĩa</th></tr></thead><tbody><tr><td>Status</td><td>Có</td><td>Active</td><td>Nhóm sản phẩm vẫn đang được kinh doanh</td></tr><tr><td>Status</td><td>Có</td><td>Inactive</td><td>Nhóm sản phẩm đã ngừng kinh doanh. Nhóm sản phẩm ở trạng thái này sẽ không được thêm vào đơn hàng mới</td></tr></tbody></table>
...
**Bước 6:** Lưu thông tin nhóm sản phẩm
...
**Q: Có cần nhập Category khi tạo nhóm sản phẩm không?**\
A: Không. Hệ thống tự tổng hợp **Category** từ chương trình học của từng sản phẩm trong nhóm.

**Q: Có cần nhập Price khi tạo nhóm sản phẩm không?**\
A: Không. Hệ thống tự tính **Price** bằng tổng giá trị của các sản phẩm trong nhóm.

**Q: Làm thế nào để thêm sản phẩm vào nhóm?**\
A: Tại trường **Products**, chọn vào vùng trống để mở danh sách sản phẩm. Sau đó chọn checkbox tại một hoặc nhiều sản phẩm và chọn **Add**.

**Q: Có thể thêm các sản phẩm Inactive vào nhóm sản phẩm không?**\
A: Không. Danh sách Products chỉ gồm các sản phẩm đang ở trạng thái Active.
...
**Q: Sau khi tạo mới, nhóm sản phẩm hiển thị ở đâu?**\
A: Nhóm sản phẩm vừa tạo sẽ hiển thị ở đầu danh sách nhóm sản phẩm.
