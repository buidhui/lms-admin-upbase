...
* **Module liên quan:** [Program](../../khoa-hoc-course/program-and-subject/)
...
#### Bước 1: Truy cập màn hình Products
...
**Q: Vì sao sản phẩm không hiển thị trong danh sách?**\
A: Có thể sản phẩm không thỏa điều kiện tìm kiếm hoặc người dùng chưa có quyền truy cập.

**Q: Sản phẩm Inactive có sử dụng được không?**\
A: Không. Sản phẩm Inactive không thể thêm vào nhóm sản phẩm hoặc đơn hàng mới.
