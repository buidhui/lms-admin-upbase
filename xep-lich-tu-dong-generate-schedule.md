...
### Thêm phòng học cho lớp sau khi tạo lịch tự động
...
### Chỉnh sửa lịch học được tạo tự động
...
![](<.gitbook/assets/image (642)>)

Hệ thống mở màn hình chỉnh sửa buổi học.

![](<.gitbook/assets/image (643)>)
{% endstep %}
...
### Xử lý khi tick Don't Reschedule
...
![](<.gitbook/assets/image (644)>)

Hệ thống hiển thị popup nhập lý do hủy.

![](<.gitbook/assets/image (645)>)
{% endstep %}
