...
![](<.gitbook/assets/image (574)>)

![](<.gitbook/assets/image (575)>)

![](<.gitbook/assets/image (578)>)
{% endstep %}
{% endstepper %}
...
![](<.gitbook/assets/image (592)>)
{% endstep %}
{% endstepper %}

### Xem danh sách học viên theo kỳ thi
...
### Đánh dấu kỳ thi là kỳ thi thực tế học viên đã đăng ký
...
![](<.gitbook/assets/image (596)>)

![](<.gitbook/assets/image (598)>)
