...
{% stepper %}
{% step %}
## Truy cập màn hình tạo mới mã khuyến mại
...
![](<.gitbook/assets/image (847)>)
{% endstep %}

{% step %}
## Chọn loại mã khuyến mại
...
![](<.gitbook/assets/image (850)>)

![](<.gitbook/assets/image (851)>)
{% endstep %}
...
![](<.gitbook/assets/image (852)>)

![](<.gitbook/assets/image (853)>)
{% endstep %}

{% step %}
## Chọn loại giảm giá và nhập lượng giảm giá
...
![](<.gitbook/assets/image (857)>)
{% endstep %}

{% step %}
## Nhập thông tin mã khuyến mại
...
![](https://sapp-academy.gitbook.io/sapp-academy/~gitbook/image?url=https%3A%2F%2F3507113425-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252Fn12m2mA5fvkSKIMRq7Tz%252Fuploads%252FOqRQpOkVkWsAvFGCKajw%252Fimage.png%3Falt%3Dmedia%26token%3D12799e6-e763-41a4-856f-1c50324b8fba\&width=768\&dpr=3\&quality=100\&sign=f43dcefd\&sv=2)
{% endstep %}
...
<summary>Nếu không muốn giới hạn số lượng mã khuyến mại thì làm thế nào?</summary>

Chọn checkbox **No quantity required**. Khi đó, người dùng không cần điền thông tin tại trường **Quantity**.

</details>

<details>

<summary>Với Apply for Product + Combo, có bắt buộc chọn cả Apply for Product và Apply for Combo không?</summary>

Không. Người dùng chỉ cần điền một trong hai thông tin **Apply for Product** hoặc **Apply for Combo**, không bắt buộc phải điền cả hai.

</details>

<details>

<summary>Discount có những loại nào?</summary>

**Discount** có thể là **Fixed**, giảm theo số tiền cụ thể, đơn vị VND, hoặc **Percentage**, giảm theo phần trăm giá trị đơn hàng.

</details>

<details>

<summary>Combined with dùng để làm gì?</summary>
