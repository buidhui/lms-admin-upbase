...
{% stepper %}
{% step %}
## Truy cập màn hình chỉnh sửa nhóm sản phẩm
...
{% step %}
## Cập nhật danh sách sản phẩm trong nhóm
...
![](<.gitbook/assets/image (835)>)

![](<.gitbook/assets/image (836)>)
{% endstep %}
...
{% step %}
## Cập nhật trạng thái nhóm sản phẩm
