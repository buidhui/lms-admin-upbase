...
**Đường dẫn:** https://ops.sapp.edu.vn/question-bank/question
...
### Xem danh sách và thông tin chi tiết câu hỏi
...
![](<.gitbook/assets/image (516)>)

![](<.gitbook/assets/image (517)>)
{% endstep %}
...
![](<.gitbook/assets/image (522)>)

![](<.gitbook/assets/image (523)>)
{% endtab %}
...
![](<.gitbook/assets/image (524)>)

![](<.gitbook/assets/image (525)>)
{% endtab %}
...
![](<.gitbook/assets/image (526)>)

![](<.gitbook/assets/image (527)>)
{% endtab %}
...
![](<.gitbook/assets/image (528)>)

![](<.gitbook/assets/image (529)>)
{% endtab %}
...
![](<.gitbook/assets/image (530)>)

![](<.gitbook/assets/image (531)>)
{% endtab %}
...
![](<.gitbook/assets/image (532)>)

![](<.gitbook/assets/image (533)>)
{% endtab %}
...
![](<.gitbook/assets/image (534)>)

![](<.gitbook/assets/image (535)>)
{% endtab %}
...
![](<.gitbook/assets/image (538)>)

_User click vào icon drop down để thực hiện thêm Answer Template_

![](<.gitbook/assets/image (539)>)

_Vùng add Answer Template cho câu hỏi không có requiement_
...
![](<.gitbook/assets/image (540)>)

_Tải file Word/Excel từ máy tính_

![](<.gitbook/assets/image (541)>)

_Chọn file Word/Excel từ Resource_

![](<.gitbook/assets/image (542)>)

_Giao diện Preview hiển thị template đã được tải lên_

![](<.gitbook/assets/image (543)>)

_Xóa file template vừa tải_

* _**Cách 2:**_ User thao tác trực tiếp trên giao diện tại vùng “Preview”.

![](<.gitbook/assets/image (544)>)

_Tạo Answer Template trực tiếp trên giao diện Preview_

Trong trường hợp câu hỏi có nhiều Requirement, nếu người dùng muốn thêm file Answer Template, tại popup **Add More Requirements** họ click vào biểu tượng Dropdown để mở vùng thêm **Answer Template**. Sau khi vùng này hiển thị, người dùng tiến hành thiết lập template trả lời tương tự như quy trình đối với câu hỏi không có Requirement.

![](<.gitbook/assets/image (545)>)

_User click vào icon drop down để thực hiện thêm Answer Template_

![](<.gitbook/assets/image (546)>)

_Vùng add Answer Template cho từng Requirement_
{% endtab %}
{% endtabs %}
{% endstep %}
...
![](<.gitbook/assets/image (547)>)

**Click vào nội dung câu hỏi**
...
![](<.gitbook/assets/image (548)>)

**Click vào nội dung câu hỏi tại màn Item Set Detail**
{% endstep %}
...
![](<.gitbook/assets/image (550)>)

_Xóa câu hỏi tại question list_

![](<.gitbook/assets/image (551)>)

_Xóa câu hỏi tại Item Set Detail_
{% endstep %}
