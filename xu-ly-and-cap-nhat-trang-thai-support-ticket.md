...
### Mở màn hình chỉnh sửa Support Ticket
...
### Cập nhật ticket từ Received sang Processing
...
### Cập nhật ticket từ Processing sang Success
...
### Cập nhật ticket từ Processing sang Failure
...
### Chuyển ticket từ Success về Processing
...
### Cập nhật Owner/Follower của ticket
...
### Hủy thao tác chỉnh sửa Support Ticket
