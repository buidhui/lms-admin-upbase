...
### 1. Quy tắc chung về Course

| Mã rule       | Business Rule                                                                                                                                     |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| BR-COURSE-001 | Người dùng chỉ được truy cập module Course khi đã đăng nhập thành công vào hệ thống OPS và được phân quyền phù hợp.                               |
...
### 4. Quy tắc về trạng thái khóa học

| Mã rule              | Business Rule                                                                                                                                              |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| BR-COURSE-STATUS-001 | Hệ thống hỗ trợ các trạng thái khóa học: **Draft, Publish, Lock, Block**.                                                                                  |
| BR-COURSE-STATUS-002 | **Draft** là trạng thái nháp và là trạng thái mặc định khi khóa học được tạo mới.                                                                          |
| BR-COURSE-STATUS-003 | **Publish** là trạng thái khóa học đã sẵn sàng để thêm vào lớp học.                                                                                        |
| BR-COURSE-STATUS-004 | **Lock** là trạng thái hệ thống tự động chuyển sang khi lớp học chứa khóa học đó đã có ít nhất một học viên tiến hành học.                                 |
| BR-COURSE-STATUS-005 | **Block** là trạng thái khóa học không thể được thêm vào lớp học.                                                                                          |
| BR-COURSE-STATUS-006 | Khóa học ở trạng thái **Draft** có thể chuyển sang **Publish** hoặc **Block**.                                                                             |
| BR-COURSE-STATUS-007 | Khóa học ở trạng thái **Publish** có thể chuyển sang **Draft** hoặc **Block**, tùy theo điều kiện đã gắn lớp/học viên.                                     |
| BR-COURSE-STATUS-008 | Khóa học ở trạng thái **Lock** không thể chuyển thủ công về Draft/Publish, nhưng có thể chuyển sang **Block**.                                             |
| BR-COURSE-STATUS-009 | Khóa học ở trạng thái **Block** có thể chuyển về **Draft**, **Publish** hoặc **Lock** tùy theo tình trạng đã gắn lớp và học viên đã học.                   |
| BR-COURSE-STATUS-010 | Course chưa được thêm vào Class: nếu đang Block thì chỉ có thể chuyển về **Draft** hoặc **Publish**.                                                       |
| BR-COURSE-STATUS-011 | Course đã được thêm vào Class nhưng chưa có học viên học: nếu đang Publish thì không thể chuyển về Draft; nếu đang Block thì chỉ có thể chuyển về Publish. |
| BR-COURSE-STATUS-012 | Course đã được thêm vào Class và đã có học viên đang học/đã học: nếu đang Block thì chỉ có thể quay lại Lock.                                              |
| BR-COURSE-STATUS-013 | Khi Block Course, khóa học vẫn giữ logic chỉnh sửa giống như trạng thái trước khi bị Block.                                                                |
| BR-COURSE-STATUS-014 | Nếu khóa học chưa có học viên học, khi Block Course, hệ thống có thể xóa Course khỏi lớp.                                                                  |
| BR-COURSE-STATUS-015 | Nếu khóa học đã có học viên học, khi Block Course, Course vẫn được giữ trong lớp và lớp vẫn hoạt động bình thường.                                         |
| BR-COURSE-STATUS-016 | Khi Block khóa Foundation chưa có học viên, hệ thống xóa lớp Foundation thay vì chỉ xóa Course khỏi lớp.                                                   |

***

### 5. Quy tắc về Course Content
...
### 9. Quy tắc về Activity và Document
...
### 10. Quy tắc về Test/Quiz trong Course
...
### 11. Quy tắc về Add Question trong Test/Quiz
...
### 12. Quy tắc về Setup Score trong Test/Quiz
...
### 14. Quy tắc về Resource của Course

| Mã rule         | Business Rule                                                                                                                                            |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| BR-RESOURCE-001 | Resource là bước thứ 3 trong quy trình tạo khóa học.                                                                                                     |
| BR-RESOURCE-002 | Danh sách Resource có thể bao gồm tài liệu upload từ Course Content và tài liệu upload trực tiếp tại bước Resource.                                      |
| BR-RESOURCE-003 | Admin có thể thêm Resource bằng cách upload trực tiếp từ thiết bị hoặc chọn từ kho học liệu của hệ thống.                                                |
| BR-RESOURCE-004 | Mỗi lần upload tối đa **10 file**.                                                                                                                       |
| BR-RESOURCE-005 | Dung lượng tối đa mỗi file là **500MB**.                                                                                                                 |
| BR-RESOURCE-006 | Các file được upload đồng thời sẽ được lưu vào kho học liệu của hệ thống.                                                                                |
| BR-RESOURCE-007 | Danh sách Resource hiển thị tên tài liệu, kích thước tài liệu và thời gian tạo.                                                                          |
| BR-RESOURCE-008 | Admin có thể tải xuống tài liệu từ menu Action của tài liệu đó.                                                                                          |
| BR-RESOURCE-009 | Admin có thể xóa tài liệu khỏi danh sách Resource của khóa học từ menu Action.                                                                           |
| BR-RESOURCE-010 | Thao tác xóa tại danh sách Resource được hiểu là xóa tài liệu khỏi khóa học; tài liệu gốc trong kho Resources có thể vẫn còn tùy theo cấu hình hệ thống. |

***

### 15. Quy tắc về Certificate của Course

| Mã rule     | Business Rule                                                                                                                  |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------ |
| BR-CERT-001 | Certificate là bước thứ 4 và là bước cuối cùng trong quy trình tạo khóa học.                                                   |
| BR-CERT-002 | Admin có thể chọn Certificate Template để gán cho khóa học.                                                                    |
| BR-CERT-003 | Certificate Template phải tồn tại và khả dụng trên hệ thống thì mới có thể chọn.                                               |
| BR-CERT-004 | Một khóa học được gán một Certificate Template tại bước Certificate.                                                           |
| BR-CERT-005 | Admin chọn **Choose Template** để mở danh sách mẫu chứng chỉ.                                                                  |
| BR-CERT-006 | Admin tick chọn template và chọn **Confirm** để xác nhận.                                                                      |
| BR-CERT-007 | Admin cần chọn **Finish** để lưu cấu hình khóa học sau khi gán chứng chỉ.                                                      |
| BR-CERT-008 | Nếu chưa có Certificate Template phù hợp, Admin cần tạo template ở module Certificates trước khi gán vào Course.               |
| BR-CERT-009 | Việc thay đổi Certificate Template của khóa học có thể ảnh hưởng đến chứng chỉ học viên nhận được sau khi hoàn thành khóa học. |

***

### 16. Quy tắc chỉnh sửa khóa học
...
### 17. Quy tắc về cập nhật cấu phần học mới cho học viên
...
### 18. Quy tắc về Learning Schedule
...
### 19. Quy tắc về Program Category / Course Category

| Mã rule        | Business Rule                                                                                 |
| -------------- | --------------------------------------------------------------------------------------------- |
| BR-PROGRAM-001 | Program Category tương ứng với Course Category trong tài liệu cũ.                             |
| BR-PROGRAM-002 | Program Category dùng để quản lý loại chương trình học/nhóm chương trình học.                 |
| BR-PROGRAM-003 | Admin có thể tìm kiếm/lọc Program Category theo tên hoặc ngày tạo.                            |
| BR-PROGRAM-004 | Khi tạo Program Category, trường tên là bắt buộc.                                             |
| BR-PROGRAM-005 | Tên Program Category không được trùng với Program Category đã tồn tại.                        |
| BR-PROGRAM-006 | Description của Program Category không bắt buộc.                                              |
| BR-PROGRAM-007 | Program Category đã tạo thì không thể xóa khỏi danh sách.                                     |
| BR-PROGRAM-008 | Admin có thể chỉnh sửa tên và mô tả Program Category.                                         |
| BR-PROGRAM-009 | Khi chỉnh sửa tên Program Category, tên mới không được trùng với Program Category đã tồn tại. |

***

### 20. Quy tắc về Subject Category

| Mã rule        | Business Rule                                                                  |
| -------------- | ------------------------------------------------------------------------------ |
| BR-SUBJECT-001 | Subject là môn học thuộc một Program.                                          |
| BR-SUBJECT-002 | Subject Category dùng để quản lý danh sách môn học theo Program.               |
| BR-SUBJECT-003 | Admin có thể tìm kiếm/lọc Subject theo từ khóa, Program, From date và To date. |
| BR-SUBJECT-004 | Khi tạo Subject, trường **Name** là bắt buộc.                                  |
| BR-SUBJECT-005 | Khi tạo Subject, Admin cần chọn Program tương ứng.                             |
| BR-SUBJECT-006 | Code dùng để định danh Subject trên hệ thống.                                  |
| BR-SUBJECT-007 | Admin có thể chỉnh sửa Name, Code và Program của Subject nếu được phép.        |
| BR-SUBJECT-008 | Subject đã được gán với khóa học thì không thể xóa.                            |
| BR-SUBJECT-009 | Nếu Subject chưa được gán với khóa học, Admin có thể xóa Subject nếu có quyền. |

***

### 21. Quy tắc về Copy Course Content
...
### 22. Quy tắc về Link Course Content
...
### 23. Quy tắc xóa dữ liệu trong Course
