...
| ---------------- | --------------------------------------------- | --------------------- | ---------------------------------------------------- | --------- |
| 29/06/2026       | [it-ba@sapp.edu.vn](mailto:it-ba@sapp.edu.vn) | A                     | Khởi tạo tài liệu theo template mới từ Confluence UG | v2.0.0    |
...
* **Draft:** Chỉnh sửa toàn bộ: Test Info, Sections (bao gồm danh sách câu hỏi), và Settings. Click vào tên bài kiểm tra → Click Edit → Chỉnh sửa thông tin cần thay đổi → Click Save.
* **Active:** Quyền chỉnh sửa phụ thuộc vào việc đã có học viên đăng ký chưa. Click vào tên bài kiểm tra → Click Edit → Chỉnh sửa các trường được phép → Click Save.
* **Locked:** Chỉ được sửa một số trường giới hạn. Click vào tên bài kiểm tra → Click Edit → Chỉnh sửa các trường được phép → Click Save.
* **Deactivated:** Không thể chỉnh sửa bất kỳ thông tin nào. Đây là trạng thái cuối — không thể chuyển lại.
...
📩 Cần hỗ trợ thêm? Liên hệ [**it-ba@sapp.edu.vn**](mailto:it-ba@sapp.edu.vn) hoặc tạo ticket hỗ trợ nội bộ.
