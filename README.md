...
# Giới thiệu tổng quan - LMS Admin User Guide

#### LMS Admin là gì?

LMS Admin là hệ thống quản lý vận hành toàn bộ hoạt động đào tạo — từ lúc học viên đăng ký học cho đến khi hoàn thành khóa học và nhận chứng chỉ. Hệ thống này là công cụ làm việc hàng ngày của các bộ phận Admin, CX, SX và lễ tân, để các bộ phận cùng làm việc trên một nguồn dữ liệu duy nhất.

***

#### Tài liệu này dành cho ai?

| Đối tượng                  | Vai trò trong LMS Admin                                                                                             |
| -------------------------- | ------------------------------------------------------------------------------------------------------------- |
...
LMS Admin được thiết kế xuyên suốt theo **hành trình học tập của học viên**, chia làm 3 giai đoạn chính:
...
<figure><img src=".gitbook/assets/LMS_HUB-Page-13.drawio (3).png" alt=""><figcaption><p>Luồng tổng quan quản lý hành trình học tập của học viên trên LMS Admin</p></figcaption></figure>

#### Một số điểm cần lưu ý khi sử dụng tài liệu này

**Tài liệu được tổ chức theo module**, mỗi module tương ứng với một nhóm chức năng trong hệ thống LMS Admin. Người dùng có thể đọc toàn bộ hoặc tra cứu module liên quan đến công việc của mình.
