...
### Chỉnh sửa thông tin từ màn Class Detail
...
### Chỉnh sửa thông tin lớp tại tab Settings
...
### Chỉnh sửa Create Hybrid Class đối với lớp Lesson
...
### Chỉnh sửa Class Owner và CX Admin
