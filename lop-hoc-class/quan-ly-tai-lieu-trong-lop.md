...
| Cột thông tin | Mô tả                                                      |
| ------------- | ---------------------------------------------------------- |
| File name     | Tên tài liệu hoặc thư mục.                                 |
| Size          | Dung lượng tài liệu.                                       |
| Date          | Thời gian tạo mới hoặc chỉnh sửa tài liệu.                 |
| Owner         | Người upload tài liệu.                                     |
| Lesson        | Buổi học được gắn với tài liệu.                            |
| Location      | Vị trí lưu trữ của tài liệu trong thư mục Class Resources. |
| Access        | Đối tượng được chia sẻ tài liệu (Student, Teacher).        |
...
### Tạo mới thư mục / Tải tài liệu lên hệ thống
